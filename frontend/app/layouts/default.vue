...
const translations = {
    fr: {
        ...
        dashboardDescription:
            "Retrouvez ici les graphiques, les cartes interactives et les statistiques en temps réel.",
        // Realtimeindicators
        ...
        high: "60 < Élevé",
        desccont:
            "Faible #contraste < 30, Moyen 30 < #contraste < 60, et Élevé #contraste > 60.",
        ...
        dashboardDescription:
            "Visualisations interactives et statistiques en temps réel",
        //Carte Dashboard
        end: "Fin : ",
        depID: "Dépôt ID :",
        seeimg: "Voir l'image",
        ...
        lieu: "Placez le curseur sur la carte",
        env: "Envoyer",
        ...
        navtips:
            "Utilisez les flèches ou raccourcis clavier pour parcourir les images.",
        prec: "Précédente",
        suiv: "Suivante",
        ...
        relanceIA: "Relancer la prédiction IA sur toutes les images",
    ...
    en: {
        ...
        dashboardDescription:
            "Soon, graphs, interactive maps, and collection statistics will be displayed here.",
        // Realtimeindicators
        ...
        high: "60 < High",
        desccont:
            "Low #contrast < 30, Medium 30 < #contrast < 60, and High #contrast > 60.",
        ...
        lieu: "Place the cursor on the map",
        env: "Send",
        ...
        navtips:
            "Use the arrows or keyboard shortcuts to navigate through the images.",
        prec: "Previous",
        suiv: "Next",
    ...
    ar: {
        ...
        dashboardDescription:
            "الرسوم البيانية، الخرائط التفاعلية، والإحصائيات في الوقت الحقيقي.",
        // Realtimeindicators
